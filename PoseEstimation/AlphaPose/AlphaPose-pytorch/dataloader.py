...
class DetectionLoader:
    def __init__(self, dataloder, batchSize=1, queueSize=1024):
        # initialize the file video stream along with the boolean
        # used to indicate if the thread should be stopped or not
        self.det_model = Darknet("./PoseEstimation/AlphaPose/AlphaPose-pytorch/yolo/cfg/yolov3-spp.cfg")
        self.det_model.load_weights('./PoseEstimation/AlphaPose/AlphaPose-pytorch/models/yolo/yolov3-spp.weights')
